...
def generate_qr_image_with_icon(
    ...
    Args:
        ...
        error_correction: Mức độ sửa lỗi (ERROR_CORRECT_L, M, Q, H). Mặc định H (cao nhất)
    ...
    # Tạo QR code với error correction cao hơn để vẫn scan được khi có icon
    qr = qrcode.QRCode(
        version=1,
    ...
    try:
        ...
        resampling = Image.LANCZOS  # Pillow < 10.0.0
